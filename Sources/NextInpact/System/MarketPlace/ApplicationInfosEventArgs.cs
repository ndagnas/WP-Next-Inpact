		...
		public void SuggestUpdateIfNewer ( Version Current )
			...
			if ( IndexVersion != -1 )
				...
				try
					...
					Brush      Foreground = (Brush     )Application.Current.
															 Resources["PhoneForegroundBrush"    ];
					FontFamily FontFamily = (FontFamily)Application.Current.
															 Resources["PhoneFontFamilySemiLight"];
					double     FontSize   = ( DeviceInfos.DeviceType == DeviceType.Phablet ) ? 
					                                                               18.667 : 22.667;
					//-----------------------------------------------------------------------------------------------------------
